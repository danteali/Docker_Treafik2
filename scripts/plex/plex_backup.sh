...
LOCATION_DB=/storage/Docker/plex/data/Library/Application\ Support/Plex\ Media\ Server/Plug-in\ Support/Databases
LOCATION_PREFS=/storage/Docker/plex/data/Library/Application\ Support/Plex\ Media\ Server/Plug-in\ Support/Preferences
LOCATION_PREFS_XML=/storage/Docker/plex/data/Library/Application\ Support/Plex\ Media\ Server/Preferences.xml
COPIES_TO_KEEP=2
#
...
find "$DESTINATION" -maxdepth 1 -name "*.zip" | sort -r | tail -n +$COPIES_TO_KEEP_PLUSONE | xargs rm > /dev/null 2>&1
