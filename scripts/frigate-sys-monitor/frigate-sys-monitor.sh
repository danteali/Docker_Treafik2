...
# CHECK DISK USAGE?
DISK_USE_CHECK=1
DISK_THRESHOLD=88  # Disk usage percentage threshold
...
NOTIFICATIONS=1  # Set to 1 to send notifications when services restarted.
...
LOGLENGTH=14400   # Note, each execution takes approx. 10 lines
